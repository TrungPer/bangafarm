                    ...
                    <div class="chat-content">
                        <div class="col-md-12 chats">
                            <ul class="p-0 dataUL" id="dataULL">
                                <?php
                                    $api_url="https://api.telegram.org/bot5691991315:AAF9GtfZowKKg63lBP6_7IlAPYKd-tABhME/getUpdates";
    ...
    <script>
        ...
        function myTest(){
            ...
            contentSP.appendChild(li).innerHTML = 
                ...
                +'</div>';
            $.ajax({
                url:'https://api.telegram.org/bot5691991315:AAF9GtfZowKKg63lBP6_7IlAPYKd-tABhME/sendMessage',
                method:'POST',
                data:{
                    chat_id:1773862148,
        ...
        function myFunction() {
            setInterval(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: 'https://api.telegram.org/bot5691991315:AAF9GtfZowKKg63lBP6_7IlAPYKd-tABhME/getUpdates',
                    dataType: 'html',
